                                ...
                                <div class="col-md-12">
                                    <div class="section-title">
                                        ...
                                        <h4 style="color: #D50000">
                                            Chương trình áp dụng từ {{$start->hour}} giờ ngày {{date_format($start,'d-m-Y')}}
                            ...
                            @foreach($listSP as $row)
                                ...
                                <!-- Product Single -->
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        ...
                                        <div class="product-body">
                                            {{--Giá sản phẩm--}}
                                            <h3 class="text-center product-price">{{number_format($row['sp_gia_ban'])}} <u>đ</u>
                                                {{-- Giá cũ = giá bán hiện tại / 1 - (giá khuyến mãi/100))--}}
                                                <del class="product-old-price">
                                                    {{number_format($row['sp_gia_ban'] / (1 - ($title['km_gia']/100)))}} <u>đ</u>
                                                </del>
                                            </h3>
