            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                <form action="admin/loaikhuyenmai/sua/{{$loaikhuyenmai->km_id}}" method="POST">
                  ...
                  <div class="form-group">
                      ...
                      <input class="form-control" name="km_ngay_bat_dau" value="{{$loaikhuyenmai->km_ngay_bat_dau}}" placeholder="Nhập ngày khuyến mãi bắt đầu" />
                  </div>
                  <div class="form-group">
                      <label>Ngày kết thúc :</label>
                      <input class="form-control" name="km_ngay_ket_thuc" value="{{$loaikhuyenmai->km_ngay_ket_thuc}}" placeholder="Nhập ngày khuyến mãi kết thúc" />
                  </div>
                  <div class="form-group">
