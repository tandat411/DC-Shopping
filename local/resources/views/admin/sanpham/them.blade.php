            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                <form action="admin/sanpham/them" method="POST">
                  ...
                  <div class="form-group">
                      ...
                      <input class="form-control" name="sp_so_luong_ton_kho" placeholder="Nhập số lượng tồn kho sản phẩm" />
                  </div>
                  <div class="form-group">
                      <label>Giá niêm yết :</label>
                      <input class="form-control" name="sp_gia_niem_yet" placeholder="Nhập giá niêm yết" />
                  </div>
                  <div class="form-group">
                      <label>Giá bán :</label>
                      <input class="form-control" name="sp_gia_ban" placeholder="Nhập giá bán sản phẩm" />
                  </div>
                  <div class="form-group">
                      <label>Mô tả :</label>
                      <input class="form-control" name="sp_mo_ta" placeholder="Điền thông tin mô tả sản phẩm" />
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="created_at" placeholder="Nhập ngày tạo sản phẩm" />
                  </div>
