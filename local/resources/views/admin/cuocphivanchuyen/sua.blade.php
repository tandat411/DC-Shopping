            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                <form action="admin/cuocphivanchuyen/sua/{{$cuocphivanchuyen->cpvc_id}}" method="POST">
                  ...
                  <div class="form-group">
                      ...
                      <input class="form-control" name="cpvc_thanh_pho" value="{{$cuocphivanchuyen->cvpc_thanh_pho}}" placeholder="Nhập thành phố" />
                  </div>
                  <div class="form-group">
                      <label>Giá cước :</label>
                      <input class="form-control" name="cpvc_gia_cuoc" value="{{$cuocphivanchuyen->cvpc_gia_cuoc}}" placeholder="Nhập giá cước" />
                  </div>
                  <div class="form-group">
