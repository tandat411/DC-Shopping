            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                <form action="admin/donhang/them" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="dh_tong_tien" placeholder="Nhập tổng tiền đơn hàng" />
                    </div>
                    <div class="form-group">
                        <label>Ngày đặt hàng :</label>
                        <input type="date"class="form-control" name="dh_ngay_dat_hang" placeholder="Nhập ngày đặt hàng" />
                    </div>
                    <div class="form-group">
                        <label>Ngày giao hàng :</label>
                      <input type="date" class="form-control" name="dh_ngay_giao_hang" placeholder="Nhập ngày giao hàng" />
                    </div>
                    <div class="form-group">
