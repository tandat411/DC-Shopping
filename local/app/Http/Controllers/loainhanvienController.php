...
class loainhanvienController extends Controller
{
  ...
  public function postThem(Request $request){
    $this->validate($request,[
      'lnv_ten'=>'required|min:3|max:100',
      'lnv_luong_co_ban'=>'required|min:7|max:9'
    ],
    [
      'lnv_ten.required'=>'Bạn chưa nhập tên loại nhân viên',
      'lnv_ten.min'=>'Tên loại nhân viên chưa đủ 3 kí tự',
      'lnv_ten.max'=>'Bạn chỉ nhập ít hơn 100 kí tự',
      'lnv_luong_co_ban.required'=>'Bạn chưa nhập lương cơ bản của nhân viên',
      'lnv_luong_co_ban.min'=>'Lương cơ bản trên 7 số',
      'lnv_luong_co_ban.max'=>'Lương cơ bản < 10 số',
    ]);
