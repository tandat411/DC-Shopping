...
class nhanvienController extends Controller
{
  ...
  public function postThem(Request $request){
        $this->validate($request,[
          ...
          'nv_sdt'=>'required|min:9|max:11',
          'nv_dia_chi'=>'required|min:10',
          'nv_email'=>'required|min:10',
          'nv_so_ngay_nghi'=>'required|min:0|max:3'
        ],
        [
          ...
          'nv_sdt.required'=>'Bạn chưa nhập số điện thoại',
          ...
          'nv_dia_chi.min'=>'Địa chỉ lớn hơn 10 kí tự',
          ...
          'nv_so_ngay_nghi.min'=>'Số ngày nghỉ nhỏ hơn 3 kí tự',
        ]);
        ...
        $nhanvien->created_at=$request->created_at;
        $nhanvien->save();
    ...
    public function postSua(Request $request,$id){
          ...
          $nhanvien->nv_email=$request->nv_email;
          $nhanvien->nv_so_ngay_nghi=$request->nv_so_ngay_nghi;
          $nhanvien->updated_at=$request->updated_at;
          $nhanvien->save();
